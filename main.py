...
if __name__ == '__main__':
	...
	# res = n_game_match(
	# 	MCTSAgent("model_weights/mcts_checkpoint_8300_v2.pth"), 
	...
	play_game(
		MCTSAgent("model_weights/mcts_checkpoint_16700_noisy_random.pth"),
		MCTSAgent("model_weights/mcts_checkpoint_16400_noisy_random.pth"),
		#UserAgent(),
		max_moves = 32,
		print_info = True,
		)
